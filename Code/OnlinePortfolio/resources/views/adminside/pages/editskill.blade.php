  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        <div class="form-group"><h1> UPDATE SKILL  </h1></div>
        <form method="POST" action="/skill/update&<?php echo $skill->id ?>">

                <div width="100%" class="form-group required">
                  <div  class="col-md-6">Skill name</div>
                  <div class="col-md-6"><input type="text" name="name" value="<?php echo $skill->name ?>"></div>
                </div></br>
